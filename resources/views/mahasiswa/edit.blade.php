                        ...
                        <div class="card-body">
                            <form action="{{ url ('edit-mahasiswa')}}/{{ $data->id }}" method="post">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" id="nims" name="nim" value="{{old('nim', $data->nim)}}" class="form-control">
                                </div>
                                <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" id="smt" name="semester" value="{{old('semester', $data->semester)}}" class="form-control">
                                </div>
                                <!-- <div class="form-group mb-3">
